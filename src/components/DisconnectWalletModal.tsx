...
export default function DisconnectWalletModal({
  ...
  return isOpen ? (
    <div className="w-screen h-screen fixed top-0 right-0 z-10 flex justify-center items-center bg-black/[0.5]">
      <div className="relative bg-primary w-[605px] h-[303px] flex flex-col justify-center items-center border-[1.5px] border-gray5 px-[70px] shadow-[0_0px_0px_10px_rgba(0,0,0,0.4)]">
