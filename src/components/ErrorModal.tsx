...
export default function ErrorModal() {
  ...
  return error ? (
    ...
    >
      <div className="relative bg-primary w-[605px] min-h-[244px] flex flex-col justify-center items-center border-[1.5px] border-gray10 px-[70px] shadow-[0_0px_4px_10px_rgba(0,0,0,0.4)]">
