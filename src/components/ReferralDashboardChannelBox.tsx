...
export default function ReferralDashboardChannelBox({
  ...
  return (
    <div className="mb-[30px] mr-[30px] w-full sm:w-[277px] h-[193px] bg-black border-[1px] border-gray10 flex flex-col justify-start shadow-[0_0px_4px_4px_rgba(0,0,0,0.25)]">
      {banner ? (
        <Image
          src={banner}
          width={275}
