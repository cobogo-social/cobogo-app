...
export default function StakeStepFiveModal({
  ...
  return (
    <div className="relative bg-primary w-full sm:w-[858px] h-full sm:h-[412px] flex justify-between border-[1.5px] border-gray10 shadow-[0_0px_4px_10px_rgba(0,0,0,0.4)]">
