...
export default function StakeStepThreeModal({
  ...
  return (
    <div className="relative bg-primary w-full sm:w-[858px] h-full sm:h-[680px] flex justify-between border-[1.5px] border-gray10 pl-[50px] pr-[50px] sm:pr-0 shadow-[0_0px_4px_10px_rgba(0,0,0,0.4)]">
