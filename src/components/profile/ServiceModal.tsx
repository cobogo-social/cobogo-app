...
export default function ServiceModal({
  ...
  return isOpen ? (
    <div className="w-screen h-screen fixed top-0 right-0 z-10 flex justify-center items-center bg-black/[0.5]">
      <div className="relative bg-primary w-full sm:w-[598px] h-full sm:h-auto flex flex-col border border-gray10 p-[40px] sm:p-[70px] shadow-[0_0px_4px_10px_rgba(0,0,0,0.4)]">
